		...
		10: [function(t, n, r) {
			! function(t) {
				...
				function e(n, r) {
					...
					a.wrapper.CodeMirror = this, c(this), l(this), r.lineWrapping && (this.display.wrapper.className += " CodeMirror-wrap",this.display.wrapper.id = "paper"), r.autofocus && !Ao && a.input.focus(), v(this), this.state = {
						keyMaps: [],
						overlays: [],
						modeGen: 0,
						overwrite: !1,
				...
				function m(e, t, n) {
					...
					var r = this.vert = ji("div", [ji("div", null, null, "min-width: 1px;")], "CodeMirror-vscrollbar"),
						i = this.horiz = ji("div", [ji("div", null, null, "height: 100%; min-height: 1px;border-radius: 5px;")], "CodeMirror-hscrollbar");
		...
		20: [function(e, t, n) {
			...
			function N(e) {
				...
				/editor-preview-active-side/.test(r.className) ? (r.className = r.className.replace(/\s*editor-preview-active-side\s*/g, ""), i.className = i.className.replace(/\s*active\s*/g, ""), n.className = n.className.replace(/\s*CodeMirror-sided\s*/g, " ")) : (setTimeout(function() {
					t.getOption("fullScreen") || s(e), r.className += " editor-preview-active-side",r.id = "monitor"
